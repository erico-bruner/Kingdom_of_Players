  ...
  <div class="collapse navbar-collapse" class="col-md-6" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        <a style="padding: 15px;"  class="nav-link dropdown-toggle active" href="perfil.php" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding: 10px;">
          <label>Perfil</label>
        </a>
